...
struct PlannedProductCell: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                    ...
                    .alert(isPresented: $showAlert) {
                        Alert(
                            ...
                            primaryButton: .destructive(Text("Delete")) {
                                ...
                                viewModel.deletePlannedProduct(product)
                            },
                ...
                Button {
                    viewModel.toMyCollection(product)
                } label: {
                    ZStack {
                        Rectangle()
            ...
            .sheet(isPresented: $showEditProductSheet, content: {
                EditProductUIView(viewModel: viewModel, showAddProductSheet: $showEditProductSheet, product: product, productType: .planned)
            })
    }
}

#Preview {
    PlannedProductCell(viewModel: CollectionViewModel(), product: Product(name: "WELLA", brand: "FLEX Hairspray \nMEN MEGA SPRAY", price: 5.0, isPopular: false))
}
